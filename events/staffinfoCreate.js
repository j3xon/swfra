        ...
        if (interaction.isStringSelectMenu()) {
            if (interaction.customId === 'staff_info') {
                ...
                switch (interaction.values[0]) {
                    case 'staffinfo':
                        const serverRules = [
                        `Welcome to the **Southwest Florida Roleplay Adventures Staffing Department!** This is all of our staff information! Everything you will ever need will be here! If you have questions, please ask a staff member. Thank you for being with us and joining our team!
...
**Banned Roleplays Southwest Florida Roleplay Adventures**
