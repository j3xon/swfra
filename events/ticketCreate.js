...
module.exports = {
    ...
    async execute(interaction) {
        const logChannelId = '1271089061112713310'; 
        ...
        try {
            if (interaction.isStringSelectMenu()) {
                ...
                if (interaction.customId === 'ticket_select') {
                    ...
                    const generalStaffRoleId = '1271086268347842690'; 
                    const staffReportRoleId = '1271084417456017490'; 
